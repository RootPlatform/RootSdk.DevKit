---
path: app-api-reference/server/type-aliases/ChannelMessageEvents.md
audience: app
category: reference
...
```typescript
import { rootServer, ChannelMessageEvent, ChannelMessageReactionDeletedFullEvent } from "@rootsdk/server-app";
