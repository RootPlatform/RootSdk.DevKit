---
path: app-api-reference/server/type-aliases/ChannelMessageEditedEvent.md
audience: app
category: reference
summary: Event data emitted when a message's content is modified.
---
...
> `optional` **messageUris**: [`MessageUri`](MessageUri.md)[]

Optional array of `MessageUri` objects containing URIs and attachment metadata.

### parentMessages?

> `optional` **parentMessages**: [`ParentMessage`](ParentMessage.md)[]
...
> `optional` **reactions**: [`MessageReaction`](MessageReaction.md)[]
