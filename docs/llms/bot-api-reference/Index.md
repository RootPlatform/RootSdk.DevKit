...
- [BillingPaymentType](enumerations/BillingPaymentType.md) - Enumeration (Billing).
- [BillingSubscriptionType](enumerations/BillingSubscriptionType.md) - Enumeration (Billing).
...
- [CommunityLogAction](enumerations/CommunityLogAction.md) - Enumeration (Community).
...
- [MessagePayloadAction](enumerations/MessagePayloadAction.md) - Enumeration (Messages).
- [MessageType](enumerations/MessageType.md) - Enum indicating the type of message.
- [MessageVoteType](enumerations/MessageVoteType.md) - Enumeration (Messages).

#### Notifications

Notification types and delivery.

- [NotificationType](enumerations/NotificationType.md) - Enumeration (Notifications).

#### Networking

Low-level packet and networking error types.

- [PacketErrorCode](enumerations/PacketErrorCode.md) - Enumeration (Networking).
- [PacketType](enumerations/PacketType.md) - Enumeration (Networking).
...
- [UserCommunityInviteConnection](enumerations/UserCommunityInviteConnection.md) - Enumeration (Users).
- [UserDeviceOnlineStatus](enumerations/UserDeviceOnlineStatus.md) - Enumeration (Users).
- [UserDirectMessageInviteConnection](enumerations/UserDirectMessageInviteConnection.md) - Enumeration (Users).
- [UserFlagProperty](enumerations/UserFlagProperty.md) - Enumeration (Users).
- [UserFriendshipInviteConnection](enumerations/UserFriendshipInviteConnection.md) - Enumeration (Users).
- [UserOnlineStatus](enumerations/UserOnlineStatus.md) - A community member's current online status.
- [UserType](enumerations/UserType.md) - Enumeration (Users).
...
- [BotStartingCallback](type-aliases/BotStartingCallback.md) - Callback invoked during bot server startup, after the database initializes but before the server begins processing events.
- [BotStoppingCallback](type-aliases/BotStoppingCallback.md) - Callback invoked during graceful bot server shutdown, before the server disconnects from Root's infrastructure.
...
- [RootBotLifecycle](type-aliases/RootBotLifecycle.md) - Manages the startup and shutdown sequence for your bot's server.
- [RootBotStartState](type-aliases/RootBotStartState.md) - Snapshot of the community's current state, passed to your `BotStartingCallback` during bot server startup.
