---
path: app-docs/develop/server/persistence/persistence-sqlite.md
audience: app
category: guide
...
In addition, you use the Root-provided [database filename](../../../../app-api-reference/server/type-aliases/RootDatabaseConfig.md#filename) at: `rootServer.dataStore.config.sqlite3.filename` in your initialization code. You must use this filename, so Root knows where your data is stored and can do automated backups for you.
