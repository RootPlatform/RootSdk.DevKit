...
//
// Copy verbatim across DevKit samples — same shape in pixel-canvas and
// leveling-leaderboard. Forks should keep the helper unchanged and add
// their own per-domain context fields at the call sites.
// ============================================================================
