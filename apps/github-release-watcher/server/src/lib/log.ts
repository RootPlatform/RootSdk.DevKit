...
// context (errorCode, owner, name, etc.) rather than free-form strings.
//
// Copy verbatim across DevKit samples — same shape in leveling-leaderboard
// and pixel-canvas. Forks should keep the helper unchanged and add their
// own per-domain context fields at the call sites.
// ============================================================================
