...
audience: app
category: guide
summary: Your App runs inside Root—it should feel like part of Root. That means using the same tools and patterns the platform uses to interact with community...
---
