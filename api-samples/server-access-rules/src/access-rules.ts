...
// channels/ api sample for a full explanation of the eventHandlers pattern.
//
// ============================================================================
...
export function initializeAccessRules(): void {
  ...
  // and channel-groups/ api samples.
...
// call returns. See the channels/ api sample for a full explanation.
