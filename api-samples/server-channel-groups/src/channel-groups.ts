...
// accessRuleUpdate: batch create/edit/delete access rules inline (see access-rules/ api sample).
...
// creation/deletion. See the channels/ api sample for a full explanation.
