...
- `channel.createMessage` — only for the `/member-roles` command trigger, not for member role operations
...
- **Roles are defined separately** — see the `roles/` how-to for creating and managing role definitions.
