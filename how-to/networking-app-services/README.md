...
This is a workspace-based how-to (`networking/` + `server/` + `client/`) because proto compilation requires the `rootsdk build proto` toolchain. Other how-tos are flat packages.
