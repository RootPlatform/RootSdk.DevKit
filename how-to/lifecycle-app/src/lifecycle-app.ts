// ============================================================================
// How-To: Lifecycle (App)
// SDK: rootServer.lifecycle.start, .stop
// Permissions: channel.createMessage (for the /lifecycle-app command only)
// Events: none
...
// The /lifecycle-app command reports this to the channel.
...
async function onLifecycleAppCommand(evt: ChannelMessageCreatedEvent): Promise<void> {
  ...
  if (!content.startsWith("/lifecycle-app")) return;
