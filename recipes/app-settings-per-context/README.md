...
Open the client URL Vite prints. As an admin you'll see the Add form at the top and per-row inline editors. As a non-admin you'll see the same list read-only.
