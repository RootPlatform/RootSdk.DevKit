...
Open the client URL Vite prints. As an admin you'll see the form editable; the Save button activates only when something differs from the saved values. As a non-admin you'll see the same values rendered read-only.
